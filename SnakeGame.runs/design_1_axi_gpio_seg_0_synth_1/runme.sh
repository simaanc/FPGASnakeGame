...
HD_PWD='C:/Vivado/SnakeGame/SnakeGame.runs/design_1_axi_gpio_seg_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_axi_gpio_seg_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_axi_gpio_seg_0.tcl
